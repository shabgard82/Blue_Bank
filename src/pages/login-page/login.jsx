...
function Login() {
  ...
  return (
    <Stack className={styles.all}>
      ...
      <Stack pt={3}>
        <Button variant="contained"  sx={{ fontWeight:500}}>Login with password</Button>
      </Stack>
      <Stack pt={1}>
        <Button variant="primary" onClick={handleClick} sx={{ color: "#4d94ff", fontSize: "15px" , fontWeight:550}}>
          I need help
        </Button>
      </Stack>
